...
public class NoFaceEditText extends EditText {

    int maxLength = -1;

    public NoFaceEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        addListener(attrs);
    }

    public NoFaceEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        addListener(attrs);
    }

    public NoFaceEditText(Context context) {
        super(context);  
        addListener(null);  
    }  
